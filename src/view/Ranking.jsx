...
export default function Ranking() {
  return (
    <>
      <div className=' w-[100%] h-[46px] p-[11.25px_15px]'>
        <p className=' text-[16px] text-[#010101] text-center font-[600]'>MV排行榜</p>
      </div>
      <Tabs className='text-[#9599a3] '
        style={{
...
function Area(props) {
  ...
  useEffect(() => {
    axios.get(`https://netease-cloud-music-api-five-roan-88.vercel.app/top/mv?limit=50&area=${props.area}`)
      .then(res => {
        ...
        {list.map((item, index) => (
          <div key={index} className=' w-[345px]'>
            <div className=' relative'>
              <img src={item.cover} alt="" className=' w-[345px] h-[195px] rounded-[12px] mb-[10px]' />
