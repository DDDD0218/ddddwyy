...
function Like() {
  ...
  return (
    <div>
      <div className=" w-[342px] h-[75px] flex justify-between items-center mx-[16px]">
        <Link to={"/"}>
          <Icon
            icon="iconoir:arrow-left"
            className=" text-[24px] text-[#283349]"
          />
        </Link>
        <SearchBar
          placeholder="念-薛之谦"
      ...
      <div className=" flex justify-around text-[13px] text-[#000000] font-[600] mt-[12px]">
        <div className=" flex items-center">
          <Icon
            icon="octicon:person-fill-16"
            className=" text-[red] text-[18px]"
          />
          <p className=" ml-[7.5px]">歌手</p>
        </div>
        <div className=" flex items-center">
          <Icon icon="clarity:book-solid" className=" text-[red] text-[18px]" />
          <p className=" ml-[7.5px]">曲风</p>
        </div>
        <div className=" flex items-center">
          <Icon
            ...
            className=" text-[red] text-[18px]"
          />
          <p className=" ml-[7.5px]">专区</p>
        </div>
        <div className=" flex items-center">
          <Icon icon="ph:microphone-fill" className=" text-[red] text-[18px]" />
          <p className=" ml-[7.5px]">识曲</p>
        </div>
      </div>
      <div className=" mt-[18px]">
        <div className=" w-[100%] h-[22.5px] flex justify-between items-center px-[11.25px]">
          <h1 className=" text-[15px] text-[#283349] font-[600]">猜你喜欢</h1>
          <Icon
            icon="ic:baseline-refresh"
            className=" text-[21px] text-[#9396a2]"
          />
        </div>
        <div className=" px-[11.25px] flex">
    ...
    <Swiper.Item key={index}>
      <div className=" w-[243.75px] bg-white m-[18.75px_0_50px_10px] rounded-[6px]">
        <div className=" w-[202.5px] h-[47px] flex items-center ml-[7.5px] border-b-[1px]">
          <span className=" text-[15px] mx-[15px] line-clamp-1 overflow-hidden">
            {item.name}
          </span>
  ...
  return (
    <div>
      {list.slice(0, 20).map((item, index) => (
        <div
          key={index}
          className=" w-[236.25px] h-[30px] m-[10px_0] flex items-center"
        >
          {index < 3 ? (
            <span className=" w-[33px] text-[12px] text-[#ff0000] text-center">
              {index + 1}
            </span>
          ) : (
            <span className=" w-[33px] text-[12px] text-center">
              {index + 1}
            </span>
          )}
