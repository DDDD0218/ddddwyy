...
export default function Detailedlist() {
  ...
  return (
    <div className="w-[100vw] pb-[12vw]">
      <div className="h-[70vw] w-[100vw] bg-[#292929]">
        ...
        <div className="px-[4vw] h-[36vw] mt-[2vw]">
          <div className="h-[24vw] flex position">
          ...
          <div className="h-[4vw] flex items-center w-[90vw] overflow-hidden mt-[7vw] justify-between">
